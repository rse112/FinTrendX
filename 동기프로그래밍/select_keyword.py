...
from trend import trend_load
from datetime import datetime
import statsmodels.api as sm

# vscode에선 dtw가 작동안해서 colab으로 돌려야댐
...
def set_analysis_period(table, today, days=0, year=0, years=0):
    try:
        ...
        # 여기서 오류 처리 로직을 구현할 수 있습니다.
        print(f"An error occurred in set_analysis_period: {e}")
        # 필요한 경우 오류를 호출한 측에 알릴 수 있습니다.
        return None, None, None
...
if __name__ == "__main__":
    ...
    # 데이터 로드
    trend_data = trend_load(standard_time, search_keyword, client_id, client_secret, api_url)
